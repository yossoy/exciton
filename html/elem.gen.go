...
// The HTML Details Element (<details>) is used to create a disclosure widget
// in which information is visible only when the widget is toggled into an
// "open" state. A summary or label can be provided using the <summary>
// element.
//
...
// displayed as subscript for solely typographical reasons. Subscripts are
...
// TableRow specifies that the markup contained inside the <tr> block comprises
// one row of a table, inside which the <th> and <td> elements create header
// and data cells, respectively, within the row.
//
